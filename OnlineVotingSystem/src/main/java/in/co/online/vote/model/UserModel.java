...
import in.co.online.vote.util.EmailBuilder;
import in.co.online.vote.util.EmailMessage;
import in.co.online.vote.util.EmailUtility;
...
public class UserModel {
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		UserBean existbean = findByLogin(bean.getVoterId());
		...
		try {
			...
			pstmt.setString(10,bean.getVoterId());
	...
	public UserBean findByLogin(String voterId) throws ApplicationException {
		log.debug("Model findByLogin Started");
		StringBuffer sql = new StringBuffer("SELECT * FROM V_USER WHERE voterId=?");
		UserBean bean = null;
		Connection conn = null;
